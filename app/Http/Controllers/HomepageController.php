...
class HomepageController extends Controller
{
    public function __construct(){
        $get_meta_data = get_meta_page_data();
        View::share('metaTitle',$get_meta_data['metaTitle']);
        View::share('metaDescription',$get_meta_data['metaDescription']);
        View::share('metaKeyword',$get_meta_data['metaKeyword']);
        View::share('metaCannonical',$get_meta_data['metaCannonical']);
    }
