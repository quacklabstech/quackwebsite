			...
			<div class="row vcenter pt80">
				<div class="col-lg-7">
					<div class="page-headings">
						...
						<h1 class="mb15" data-aos="fade-in" data-aos-delay="400">Experience with cutting-edge <span class="ree-text rt40">e-commerce</span> apps</h1>
					...
					<div class="ree-card m-mt30 trust-review owl-carousel" data-aos="fade-in" data-aos-delay="500">
						...
						<div class="items">
							<div class="review-text">
								<p>Very efficient in customer relation, time management and quality of service.</p>
							</div>
							<div class="ree-row-set mt30">
								<div class="media vcenter">
									<div class="ree-icon-set img-round80"><img src="{{asset('images/users/user5.jpg')}}" alt="img" class="img-fluid"></div>
						...
						<div class="items">
							<div class="review-text">
								<p>Right ingredients to reinforce our confidence on our choice of vendor selection.</p>
							</div>
							<div class="ree-row-set mt30">
								<div class="media vcenter">
					...
					<div class="col-lg-7 m-order1 mt-5" data-aos="fade-up" data-aos-delay="200">
						<div class="hovr-scale-main">
							<div class="portfolio-flimg hovr-scale-base">
								<a href="#"> <img src="{{asset('images/portfolio/ecom-portfoilo1.jpg')}}" alt="portfolio" class="img-fluid"> </a>
							</div>
						</div>
					</div>
					<div class="col-lg-5 m-order1" data-aos="fade-up" data-aos-delay="600">
						<div class="portfolio-detls pdr-dtls">
							<p class="port-tags">B2B E-Commerce App</p>
							<a href="#" class="port-title-main" target="_blank">Zaika E-Commerce App</a>
