			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Flutter</span>
						<h1 data-aos="fade-up" data-aos-delay="400">The fast and flexible mobile app development <span class="ree-text rt40">framework</span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">It is designed to help developers build high-quality, cross-platform apps for Android and iOS quickly and efficiently.</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/flutter.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">Flutter?</span></h2>
							<p class="mb15">Flutter is an open-source mobile app development framework developed by Google. It is designed to help developers build high-quality, cross-platform apps for Android and iOS quickly and efficiently.</p>
							<p class="mb15">Flutter is built using the Dart programming language and uses a reactive framework, which allows developers to build expressive and flexible user interfaces. It also includes a rich set of pre-designed widgets and tools that make it easy for developers to create beautiful and responsive apps.
							</p>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire a experienced <span class="ree-text rt40">Flutter</span> developer for your <span class="ree-text rt40">project</span> </h2>
