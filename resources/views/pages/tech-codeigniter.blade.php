			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Codeigniter</span>
						<h1 data-aos="fade-up" data-aos-delay="400">Accelerate your web development with <span class="ree-text rt40">Codeigniter</span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">Codeigniter is a powerful open-source PHP framework used for web application development. It is known for its simple and elegant syntax, which makes it a popular choice for developers.</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/codei.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">Codeigniter?</span></h2>
							<p class="mb15">Codeigniter is an open-source PHP web application framework that is designed to help developers build dynamic, feature-rich websites and web applications. It is based on the Model-View-Controller (MVC) architecture, which helps developers to organize their code and make it easier to maintain and scale.</p>
							<p class="mb15">Codeigniter has a small footprint and requires minimal server resources, making it easy to deploy on most servers. It is also known for its excellent documentation, which is easy to understand and follow.
							</p>
							<p class="mb15">One of the key features of Codeigniter is its simplicity and ease of use. It has a straightforward syntax and provides a wide range of libraries and tools to help developers build web applications quickly and efficiently.</p>
							<p class="mb15">Codeigniter also has a large and active community of developers, who provide valuable support and resources. This makes it an excellent choice for developers who are looking for a reliable and well-supported framework for their web development projects.</p>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire world-class <span class="ree-text rt40">Codeigniter</span> Developer for your <span class="ree-text rt40">project</span> </h2>
