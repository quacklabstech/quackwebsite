			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Android</span>
						<h1 data-aos="fade-up" data-aos-delay="400">The world's most popular mobile <span class="ree-text rt40">operating system.</span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">Android is a mobile operating system developed by Google that is based on the Linux kernel.</p>
						<a href="#" class="ree-btn  ree-btn-grdt1 mt40" data-aos="fade-up" data-aos-delay="800">Let’s discuss <i class="fas fa-arrow-right fa-btn"></i></a>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/android-studio-icon.svg')}}" width="270px" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">Android?</span></h2>
							<p class="mb15">Android is a mobile operating system developed by Google that is based on the Linux kernel. It is the most widely used mobile operating system in the world, running on billions of devices including smartphones, tablets, and other mobile devices.</p>
							<p class="mb15">Android is designed to be user-friendly and easy to use, with a focus on simplicity and customization. It provides a wide range of features and functionality, including support for multiple languages, a variety of connectivity options, and access to a wide range of applications through the Google Play Store.
							</p>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire a experienced <span class="ree-text rt40">Android</span> developer for your <span class="ree-text rt40">project</span> </h2>
