			...
			<div class="portfolio-items mt60">
				...
				<div class="row">
					...
					<div class="col-lg-5 m-order1" data-aos="fade-up" data-aos-delay="600">
						<div class="portfolio-detls pdr-dtls">
							<p class="port-tags">Applicant Tracking</p>
							<a href="/solutions/app-development/web-app-development" class="port-title-main">Applicant Tracking</a>
				...
				<div class="row">
					<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="200">
						<div class="portfolio-detls pdl-dtls">
							<p class="port-tags">HR Management</p>
							<a href="/solutions/app-development/mobile-app-development" class="port-title-main">HR Management</a>
				...
				<div class="row">
					...
					<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="600">
						<div class="portfolio-detls pdr-dtls">
							<p class="port-tags">Hospital Management</p>
							<a href="/solutions/app-development/eCommerce-development" class="port-title-main">Hospital Management</a>
