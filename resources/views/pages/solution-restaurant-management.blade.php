    ...
    <section class="page-heading-sec r-bg-a pt85 pb120">
        <div class="container">
            <div class="row pt80 justify-content-center">
                <div class="col-lg-6">
                    <div class="page-headings">
                        ...
                        <h1 data-aos="fade-up" data-aos-delay="400">
                            Complete Restaurant management <span class="ree-text rt40">system</span> that does more than a POS!
                ...
                <div class="col-lg-6">
                    <div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/resturant-banner.png')}}" alt="web app development" class="img-fluid"></div>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-12 vcenter">
                        <div class="cta-heading-2">
                            <h2 class="mb15"> Why Do You Need Good <span class="ree-text rt40">Restaurant Management Software?</span></h2>
                            <p class="mb20">In the restaurant industry, the value of integrated restaurant management software solutions is sometimes ignored. They are sometimes viewed as little more than a mobile cashier. However, restaurant management software solutions are capable of much more. Modern restaurant software systems combine the functions of a computer with a cash register, allowing them to accept credit card payments, print receipts, show information on a user-friendly screen, and act as a service station.</p>
                            <p class="mb20">A centralised digital ordering system is known as a KDS. It helps simplify communication and efficiency in both your front of the house (FOH) and back of the house (BOH) in most restaurants by replacing paper tickets in the kitchen (BOH). For improved mobility, traditionally cumbersome desktops are being replaced with tablets such as iPads, thanks to technological improvements. </p>
                            <ul class="ul-list mb30 mt30">
                                <li>Capability to compute cash for each order placed during the day</li>
                                <li>Keep track of cash in and out  </li>
                                <li>Generate sales reports for multiple periods</li>
                                <li>Keep track of sales data by recording check averages daily</li>
                                <li>Recurring customers’ information recorded and saved </li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center">
                    <div class="page-headings">
                        <h2>Key Features of Restaurant Management Software</h2>
                        <p class="mt15">Simplified restaurant operations with ERP solutions to manage KOT, online orders and delivery</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt30">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ree-card  mt60">
                        <div class="ree-card-img"><img src="{{asset('images/icons/chatbot.png')}}" alt="services"> </div>
                        <div class="ree-card-content mt40">
