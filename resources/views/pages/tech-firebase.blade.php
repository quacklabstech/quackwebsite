        ...
        <div class="row pt80 justify-content-center">
            <div class="col-lg-6">
                <div class="page-headings">
                    <span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Firebase</span>
                    <h1 data-aos="fade-up" data-aos-delay="400">The complete app development <span class="ree-text rt40">platform</span> </h1>
                    <p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">It provides a wide range of tools and services that make it easier for developers to build, grow, and scale their apps.</p>
            ...
            <div class="col-lg-6">
                <div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/firebase.png')}}" alt="web app development" class="img-fluid"></div>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-lg-12 vcenter">
                    <div class="cta-heading-2">
                        <h2 class="mb15">What is <span class="ree-text rt40">Firebase?</span></h2>
                        <p class="mb15">Firebase is a comprehensive app development platform developed by Google. It provides a wide range of tools and services that make it easier for developers to build, grow, and scale their apps.</p>
                        <p class="mb15">Firebase provides a range of features that are useful for app development, including a real-time database, authentication and authorization services, analytics, hosting, and more. It is designed to be easy to use and provides a simple, intuitive interface for developers to manage their apps.
                        </p>
            ...
            <div class="row">
                <div class="col-lg-6 vcenter">
                    <div class="cta-heading">
                        <h2 class="mb15">Hire a experienced <span class="ree-text rt40">Firebase</span> developer for your <span class="ree-text rt40">project</span> </h2>
