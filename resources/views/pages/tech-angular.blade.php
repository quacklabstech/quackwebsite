			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Angular</span>
						<h1 data-aos="fade-up" data-aos-delay="400">Build powerful and scalable web applications with <span class="ree-text rt40">Angular</span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">It is based on the Model-View-Controller (MVC) architecture and is designed to make it easy for developers to build and maintain large and complex web applications.</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/angular-banner.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">Angular?</span></h2>
							<p class="mb15">Angular is a comprehensive JavaScript framework developed by Google that is used for building web applications. It is based on the Model-View-Controller (MVC) architecture and is designed to make it easy for developers to build and maintain large and complex web applications.</p>
							<p class="mb15">Angular uses a declarative programming style, which makes it easy for developers to define and update the components of their web applications. It also includes a range of features and tools that help developers to build rich and interactive user interfaces, such as support for reactive programming and two-way data binding.
							</p>
							<p class="mb15">Overall, Angular is a powerful and comprehensive framework that is well-suited for building large and complex web applications. Its declarative programming style and rich set of features make it an excellent choice for developers.</p>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire a experienced <span class="ree-text rt40">Angular</span> developer for your <span class="ree-text rt40">project</span> </h2>
