            ...
            <div class="row pt80 justify-content-center">
                <div class="col-lg-6">
                    <div class="page-headings">
                        <span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Welcome to Viral World</span>
                        <h1 data-aos="fade-up" data-aos-delay="400">

                            We help you to grow <span class="ree-text rt40">Xponentially</span><br> Brands Go Viral Here</h1>
                        <p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">We are India’s emerging influencer marketing company</p>
                ...
                <div class="col-lg-6">
                    <div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/viral-banner.png')}}" alt="web app development" class="img-fluid"></div>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-12 vcenter">
                        <div class="cta-heading-2">
                            <h2 class="mb15">
                                ...
                                <span class="ree-text rt40">Business</span>
                            </h2>
                            <p class="mb20">Viral marketing is a type of marketing that relies on word-of-mouth and social media sharing to quickly spread a message or product. It is a way to reach a large number of people quickly and with minimal expense. It works by utilizing existing social networks, such as influencers, or encouraging customers to share content with their friends and family. This type of marketing can be particularly effective for companies with limited budgets, as it does not require any paid advertising.</p>
                            <p class="mb20">Our content creators (Influencers) and marketing specialists generate unique material and devise a comprehensive influencer marketing strategy to position your product as superior by leveraging the trusted relationship between influencers and their followers. Through positive involvement, we assist businesses in improving their exposure, leads, and sales.</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center">
                    <div class="page-headings">
                        <h2>
                            With these powerful steps make your brand go viral
                        </h2>
                        <p class="mt15">In only 3 steps, we help brands go viral </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="ree-card  mt60">
                        ...
                        <div class="ree-card-content mt40">
                            <h3 class="mb15">
                                Choose Influencer</h3>
                            <p class="mb-2">Influencer marketing allows brands to convey their company objectives and what they hope to achieve. For a more personalised and tailored marketing<br><br></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="ree-card  mt60">
                        ...
                        <div class="ree-card-content mt40">
                            ...
                            <p>Our team, in collaboration with the brand and influencer, selected appropriate influencers based on their reach and targeted potential viewers. </p>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="ree-card  mt60">
                        ...
                        <div class="ree-card-content mt40">
                            ...
                            <p class="mb-4">On their respective social media channels, such as Youtube, Instagram, content creators share inspiring stories, and viewers<br></p>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="ree-card  mt60">
                        ...
                        <div class="ree-card-content mt40">
                            ...
                            <p class="mb-1">Reach your targeted audience and boost your ROI<br><br><br><br><br></p>
                        </div>
