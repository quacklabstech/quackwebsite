			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Javascript</span>
						<h1 data-aos="fade-up" data-aos-delay="400">The foundation of modern web <span class="ree-text rt40">development</span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">JavaScript is a powerful programming language that is widely used to build interactive websites and applications.</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/js-banner.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">Java Script?</span></h2>
							<p class="mb15">JavaScript is a programming language that is widely used to build interactive websites and applications. It is a client-side language, which means that it is executed by the web browser on the user's computer, rather than on a server. This makes it an essential tool for building websites and applications that need to respond to user input or events in real-time.</p>
							<p class="mb15">JavaScript is a flexible language that can be used in a variety of contexts, and it is supported by all modern web browsers. It is an essential tool for anyone interested in web development or building interactive web-based applications.</p>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire world-class <span class="ree-text rt40">Java Script</span> developers for your <span class="ree-text rt40">project</span> </h2>
