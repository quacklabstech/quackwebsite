			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						...
						<h1 data-aos="fade-up" data-aos-delay="400">power up your website with semantic <span class="ree-text rt40">markup</span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">The backbone of the internet</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/html-intro-banner.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">HTML?</span></h2>
							<p class="mb15">HTML (HyperText Markup Language) is a standard markup language used to create web pages. It is used to structure and format content on the web, and to create hyperlinks between web pages.</p>
							<p class="mb15">HTML is written in the form of HTML elements, which are typically composed of tags enclosed in angle brackets. These tags describe the content and structure of the document, such as headings, paragraphs, lists, and tables.</p>
							<p class="mb15">HTML also uses attributes to provide additional information about elements, such as specifying the size of an image or the language of a document.</p>
							<p class="mb15">Web browsers, such as Google Chrome, Mozilla Firefox, and Safari, can read and interpret HTML documents and render them as web pages. HTML is an essential building block of the web and is used to create and structure the content that is accessible on the internet.</p>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire world-class <span class="ree-text rt40">HTML</span> developers for your <span class="ree-text rt40">project</span> </h2>
