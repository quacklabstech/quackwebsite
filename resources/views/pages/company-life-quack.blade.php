  ...
  <div class="port-head-sec sec-pad r-bg-x">
    <div class="container">
      <div class="row vcenter">
        ...
        <div class="col-lg-6">
          <div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/team/life1.jpg')}}" alt="our-staff" class="img-fluid"></div>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-lg-3 mb20 col-md-6 col-sm-6 col-12">
            <a href="{{asset('images/team/life2.jpg')}}" >
              <img src="{{asset('images/team/life2.jpg')}}" alt="" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-3 mb20  col-md-6 col-sm-6 col-12">
            <a href="{{asset('images/team/life3.jpg')}}">
              <img src="{{asset('images/team/life3.jpg')}}" alt="" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-3 mb20  col-md-6 col-sm-6 col-12">
            <a href="{{asset('images/team/life4.jpg')}}">
              <img src="{{asset('images/team/life4.jpg')}}" alt="" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-3 mb20  col-md-6 col-sm-6 col-12">
            <a href="{{asset('images/team/life5.jpg')}}">
              <img src="{{asset('images/team/life5.jpg')}}" alt="" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-3 mb20 col-md-6 col-sm-6 col-12">
            <a href="{{asset('images/team/life6.jpeg')}}">
              <img src="{{asset('images/team/life6.jpeg')}}" alt="" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-3 mb20  col-md-6 col-sm-6 col-12">
            <a href="{{asset('images/team/our-staff.jpg')}}">
              <img src="{{asset('images/team/our-staff.jpg')}}" alt="" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-3 mb20  col-md-6 col-sm-6 col-12">
            <a href="{{asset('images/team/our-staff.jpg')}}">
