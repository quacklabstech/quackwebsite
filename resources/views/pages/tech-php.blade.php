			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">PHP</span>
						<h1 data-aos="fade-up" data-aos-delay="400">Powering the web with simplicity and <span class="ree-text rt40">flexibility</span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">PHP is used to create dynamic and interactive websites, and it is often used in conjunction with a database to store and retrieve data.</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/php-banner.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">PHP?</span></h2>
							<p class="mb15">PHP (Hypertext Preprocessor) is a popular programming language used primarily for web development. It is a server-side scripting language, which means that it is executed on the server rather than in the client's web browser. PHP is used to create dynamic and interactive websites, and it is often used in conjunction with a database to store and retrieve data. PHP is a popular choice for web development because it is easy to learn and use, and it has a large community of developers who contribute to its development and support.</p>
							<p class="mb15">PHP is a server-side language, which means that it is executed on the server rather than in the client's web browser. This makes it easier to create secure and scalable web applications.
								PHP has a large number of built-in functions and libraries that make it easy to perform common web development tasks, such as connecting to a database, sending emails, and handling form submissions.
							</p>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire a experienced <span class="ree-text rt40">PHP</span> developer for your <span class="ree-text rt40">project</span> </h2>
