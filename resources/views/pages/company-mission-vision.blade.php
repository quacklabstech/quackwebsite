...
@section('content')
	<!-- Header title -->
	<section class="header-title head-opacity" data-background="{{asset('images/banner/mission.jpg')}}">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-7 text-center">
					<h1 class="mb15">Our Mission</h1>
					<p class="h-light">improve people's lives by developing innovative and effective solutions</p>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="page-heading mr25">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Our Mission</span>
						<h2 data-aos="fade-up" data-aos-delay="400">Empowering businesses with innovative solutions for a <span class="ree-text rt45">better</span> tomorrow</h2>
						<p class="mt30" data-aos="fade-up" data-aos-delay="600">We are committed to delivering the highest level of quality in everything we do, from product development to customer service.
							Innovation: We are constantly pushing the boundaries of what is possible, using cutting-edge technology to create new and exciting solutions.
							Collaboration: We believe that great things are possible when people come together, and we strive to foster a culture of collaboration and teamwork within our organization.
							Integrity: We are dedicated to conducting our business with honesty and transparency, always acting in the best interests of our customers and stakeholders.
							Responsibility</p>
					</div>
				</div>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30">
						<img src="{{asset('images/mission-banner.php')}}" alt="reevan office" class="img-fluid" data-aos="fade-in" data-aos-delay="400">
					</div>
				</div>
			</div>
			...
			<div class="row ">
				...
				<div class="col-lg-7">
					<div class="pera-block">
						<h2> Our <span class="ree-tt">Vision</span></h2>
						<p>Our vision is to be a leading technology company known for our commitment to excellence and innovation, providing high-quality products and services that help people be more productive, connected, and informed.
						</p>
						<p>we are committed to staying at the forefront of the latest technological advancements. We are constantly researching and developing new products and services that can help our clients achieve their goals. From artificial intelligence and machine learning to the internet of things and blockchain, we have the expertise and the know-how to bring your ideas to life.</p>
					</div>
				</div>
			</div>
			<div class="row mt30">
				<div class="col-lg-8 mt30">
					<div class="pera-block">
						...
						<p>We are committed to delivering the highest level of quality in everything we do, from product development to customer service.
							...
							Collaboration: We believe that great things are possible when people come together, and we strive to foster a culture of collaboration and teamwork within our organization.
							Integrity: We are dedicated to conducting our business with honesty and transparency, always acting in the best interests of our customers and stakeholders.
							Responsibility: We are committed to using our expertise and resources in a way that is sustainable and responsible, for the benefit of our customers, our employees, and the world around us.</p>
					</div>
				</div>
