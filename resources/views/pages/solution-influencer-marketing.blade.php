   ...
   <section class="page-heading-sec r-bg-a pt85 pb120">
    <div class="container">
        <div class="row pt80 justify-content-center">
            <div class="col-lg-6">
                <div class="page-headings">
                    ...
                    <h1 data-aos="fade-up" data-aos-delay="400">
                        The Only <span class="ree-text rt40">Influencer</span> Marketing Agency You Will Ever Need
                    </h1>
                    <p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">Vetted influencers across 50+ genres</p>
            ...
            <div class="col-lg-6">
                <div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/influ-banner.png')}}" alt="web app development" class="img-fluid"></div>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-lg-12 vcenter">
                    <div class="cta-heading-2">
                        <h2 class="mb15">What Is <span class="ree-text rt40">Influencer Marketing </span></h2>
                        <p class="mb20">is a type of social media marketing that involves product or brand promotion through influencers. Influencers are people with a large following on social media platforms like Instagram, YouTube, and Twitter. Influencers are often the opinion leaders of their respective communities, and their followers trust their recommendations and take their advice into consideration when making purchasing decisions.</p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-5">
                <div class="ree-card  mt60 h-100">
                    ...
                    <div class="ree-card-content mt40">
                        ...
                        <p class="mb-4">Unboxing, Testimonials & Reviews with 50,000+ vetted micro-influencers<br><br></p>
                    </div>
            ...
            <div class="col-lg-6 col-sm-6 mb-5">
                <div class="ree-card  mt60 h-100">
                    ...
                    <div class="ree-card-content mt40">
                        ...
                        <p class="mb-5">Go viral with rapid distribution over 1Lac+ meme pages</p>
                    </div>
            ...
            <div class="col-lg-6 col-sm-6 mb-5">
                <div class="ree-card  mt60 h-100">
                    ...
                    <div class="ree-card-content mt40">
                        ...
                        <p class="mb-3">Build credibility with celebs across Sports, Bollywood, OTT, Stand-up comedy, TEDxSpeakers</p>
                    </div>
