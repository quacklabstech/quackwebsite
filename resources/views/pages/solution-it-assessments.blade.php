	...
	<section class="page-heading-sec r-bg-a pt85 pb120">
		<div class="container">
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						...
						<h1 data-aos="fade-up" data-aos-delay="400">
							Improve your infrastructure and make informed <br>
							<span class="ree-text rt40">decisions</span>
						</h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">you’ll gain a thorough understanding of what you can do to improve</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/it-banner.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What Is <span class="ree-text rt40">IT Assessments ?</span> </h2>
							...
							<p class="mb20">We evaluate the elements of your mission critical IT components. This includes the overall network security, backup and recovery processes, email security, and software license compliance. We also assess any antivirus solutions, hardware stability, cloud adoption, operating system and firmware versions, and user training.</p>
						</div>
					</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-7 text-center">
					<div class="page-headings">
						<h2>Our IT Assessment Services</h2>
						<p class="mt15">Are your technical capabilities limiting your business?</p>
					</div>
				</div>
			</div>
			...
			<div class="row mt30">
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						<div class="ree-card-img"><img src="{{asset('images/icons/risk.png')}}" alt="services"> </div>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						<div class="ree-card-img"><img src="{{asset('images/icons/shield-1.png')}}" alt="services"> </div>
						<div class="ree-card-content mt40">
							<h3 class="mb15">
								Security Incident Response Assessment</h3>
							<p class="mb-0">Analyze and evaluate your organization’s threat intelligence and gain actionable insight into your IT incident response capabilities<br><br></p>
						</div>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						<div class="ree-card-img"><img src="{{asset('images/icons/virus.png')}}" alt="services"> </div>
						<div class="ree-card-content mt40">
							<h3 class="mb15">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						<div class="ree-card-img"><img src="{{asset('images/icons/electrical-circuit.png')}}" alt="services"> </div>
						<div class="ree-card-content mt40">
							<h3 class="mb15">
			...
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="page-headings text-center">
						...
						<p> we offer IT consulting services that will help you to upgrade and refine your software architecture</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 mt30">
					<div class="process-content ree-card">
						...
						<div class="process-block ">
							...
							<h4>Businesses Worldwide</h4>
							<p>Our designers and experts have shown the proficiencies of arranging and actualizing complex IT arrangements in different industry verticals that help organizations develop or overcome normal business challenges <br><br></p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 mt30 ">
					<div class="process-content ree-card">
						...
						<div class="process-block">
							<div class="process-icon">
								<img src="{{asset('images/icons/collaboration.png')}}" alt="service" class="icon70 mb20">
							</div>
							<h4>Integrity</h4>
							<p class="">Our group insurances to give the best innovation empowered answers for meet your business and IT objectives. The greater part of our administrations and systems depend on industry best practices to give you an answer that will cultivate the development of your business. </p>
						</div>
					</div>
				</div>
