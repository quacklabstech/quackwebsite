			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">India's top website development company</span>
						<h1 data-aos="fade-up" data-aos-delay="400">Giving your <span class="ree-text rt40">Website</span> an Engaging New Look</h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">Make the right choice with best HTML responsive design service</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/html-banner.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">Your search for <span class="ree-text rt40">the best website designer</span> ends here!</h2>
							<p class="mb20">Your website represents your business and it must do justice to its image in the real world. The modern website development technologies, namely HTML and CSS are a perfect choice for building any type of websites. Whereas HTML takes care of your content, CSS can be employed to give the websites that vibrant, ultra-engaging and classy look that is sure to impress upon every visitor’s mind. As expert HTML/CSS developers, we know how valuable your website is to your business. With our premium services, you won’t just get a stunning website but have it climbing higher in the Google Search Engine rankings.</p>
						</div>
					</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-7 text-center">
					<div class="page-headings">
						...
						<p class="mt15">Explore our range of prowess in website development</p>
					</div>
				</div>
			</div>
			...
			<div class="row mt30">
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						...
						<div class="ree-card-content mt40">
							<h3 class="mb15">Responsive Web Design</h3>
							<p>HTML5 responsive web designs are wildly used in the current smart world as it loads faster and adjusts in all screen sizes automatically.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						...
						<div class="ree-card-content mt40">
							<h3 class="mb15">PSD to HTML5 Conversion</h3>
							<p>We provide PSD to HTML5 conversion services at our company and ensure clients for error-free coding with the latest HTML and CSS standards.</p>
						</div>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						...
						<div class="ree-card-content mt40">
							<h3 class="mb15">Website Re-design & Maintenance</h3>
							<p>A passionate team of web designers and developers are there who offers web maintenance services, in addition, altering the web designs if needed to the customer.</p>
						</div>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						...
						<div class="ree-card-content mt40">
							<h3 class="mb15">HTML5 Web App Development</h3>
							<p>The HTML5 web app development service we ensure the delivery of user-centric apps to offer an extraordinary experience.<br><br></p>
						</div>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="ree-card  mt60">
						<div class="ree-card-img"><img src="{{asset('images/icons/brush-design.png')}}" alt="services"> </div>
						<div class="ree-card-content mt40">
							<h3 class="mb15">Customized & Bespoke Design</h3>
							<p>In our HTML conversion process, we consider every design format uniformly. Our passionate team adheres to powerful coding standards to meet the expectations of the clients at par.
							</p>
						</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="page-headings text-center">
						<h2 class="mb15">Why Choose Us</h2>
						<p>We are the leading website design company in India</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 mt30">
					<div class="process-content ree-card">
						...
						<div class="process-block">
							...
							<h4>Strong Online Branding</h4>
							<p>Add a unique signature to your online branding with our visually enticing web designs promising charming fresh look, neat interface, and quick navigation layout.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 mt30">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 mt30 ">
					<div class="process-content ree-card">
						...
						<div class="process-block">
							...
							<h4>Best Branding Solutions</h4>
							<p>With our tailor-made, industry-specific designs you can create a niche for your brand and make a quick connection with your target group that helps you to grow your online business.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6 mt30">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 mt30">
					<div class="process-content ree-card">
						...
						<div class="process-block">
							...
							<h4>Neat, SEO Friendly Coding</h4>
							<p>Neat, agile, efficient and search engine friendly codes that deliver the best performance and allow your website to rank higher on search engine pages.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 mt30">
					<div class="process-content ree-card">
						...
						<div class="process-block">
							...
							<h4>Personal Identity Approach</h4>
							<p>We make custom websites with the latest designs, layout, and templates that are rich in giving attractive and intuitive UI/UX to the business.</p>
						</div>
					</div>
				</div>
	...
	<section class="r-bg-x  sec-pad">
		<div class="container">
			...
			<div class="row mt30">
				...
				<div class="col-lg-3 col-sm-6 col-6">
					<div class="industry-workfor"><img src="{{asset('images/icons/taxi.sv')}}g" alt="img">
						<h6>Transport</h6>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6 col-6">
