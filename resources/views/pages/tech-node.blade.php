			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Node js</span>
						<h1 data-aos="fade-up" data-aos-delay="400">Build high-performance web applications with <span class="ree-text rt40">Node.js</span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">It is built on top of the Chrome V8 JavaScript engine and is designed to be fast, lightweight, and scalable.</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/node-banner.svg')}}" width="450px" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">Node js?</span></h2>
							<p class="mb15">Node.js is a runtime environment for building server-side and networking applications using JavaScript. It is built on top of the Chrome V8 JavaScript engine and is designed to be fast, lightweight, and scalable.</p>
							<p class="mb15">One of the key features of Node.js is its ability to handle high levels of concurrency and I/O operations efficiently, making it well-suited for building real-time web applications and microservices. It also has a large and active community of developers who contribute to and maintain a wide range of libraries and tools that can be used with Node.js.
							</p>
							<p class="mb15">Overall, Node.js is a powerful and efficient runtime environment that is well-suited for building scalable and real-time web applications. Its event-driven architecture and non-blocking I/O model make it an excellent choice for developers.</p>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire a experienced <span class="ree-text rt40">Node</span> developer for your <span class="ree-text rt40">project</span> </h2>
