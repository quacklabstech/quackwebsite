		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-7 text-center">
					<h1 class="mb15">Digital Marketing</h1>
					<p class="h-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis quaerat, nesciunt mollitia commodi</p>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">Lorem ipsum dolor sit amet</h2>
			...
			<div class="portfolio-items mt60">
				...
				<div class="row">
					...
					<div class="col-lg-5 m-order1" data-aos="fade-up" data-aos-delay="600">
						<div class="portfolio-detls pdr-dtls">
							<p class="port-tags">Social Media Management</p>
							<a href="/solutions/app-development/web-app-development" class="port-title-main">Social Media Management</a>
				...
				<div class="row">
					<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="200">
						<div class="portfolio-detls pdl-dtls">
							<p class="port-tags">Search Engine Optimization</p>
							<a href="/solutions/app-development/mobile-app-development" class="port-title-main">Search Engine Optimization</a>
				...
				<div class="row">
					...
					<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="600">
						<div class="portfolio-detls pdr-dtls">
							<p class="port-tags">Social Media Marketing</p>
							<a href="/solutions/app-development/eCommerce-development" class="port-title-main">Social Media Marketing</a>
					...
					<div class="row">
						...
						<div class="col-lg-5 m-order1" data-aos="fade-up" data-aos-delay="600">
							<div class="portfolio-detls pdr-dtls">
								<p class="port-tags">Web Analytics</p>
								<a href="/solutions/app-development/web-app-development" class="port-title-main">Web Analytics</a>
								<p class="mb30">we specialize in creative web app development that helps businesses and organizations streamline their operations and improve efficiency. Our team of experienced developers is skilled in creating custom web applications that are tailored to the unique needs of our clients.</p>
					...
					<div class="row">
						<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="200">
							<div class="portfolio-detls pdl-dtls">
								<p class="port-tags">Content Writing</p>
								<a href="/solutions/app-development/mobile-app-development" class="port-title-main">Content Writing</a>
								<p class="mb30">With the increasing demand for businesses to have a strong online presence, a well-designed mobile app can be a game changer. Not only can it improve customer engagement and loyalty, but it can also streamline internal processes and boost productivity.</p>
								<p class="mb30">Our team has a wealth of experience in developing high-quality mobile apps across a range of industries, using the latest technologies and methodologies to deliver exceptional results. </p>
								<a href="/solutions/app-development/mobile-app-development" class="port-links ">View More <i class="fas fa-arrow-right fa-btn"></i></a>
					...
					<div class="row">
						...
						<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="600">
							<div class="portfolio-detls pdr-dtls">
								<p class="port-tags">PPC/Display & Mobile Apps</p>
								<a href="/solutions/app-development/eCommerce-development" class="port-title-main">PPC/Display & Mobile Apps</a>
								<p class="mb30"> E-commerce app development has become an increasingly popular and important aspect of modern business. With the rise of mobile technology and the increasing amount of time people spend on their smartphones, it's no surprise that e-commerce apps have become a vital tool for businesses looking to reach new customers and sell their products online.</p>
								<a href="/solutions/app-development/eCommerce-development" class="port-links">View More <i class="fas fa-arrow-right fa-btn"></i></a>
				...
				<div class="row">
					...
					<div class="col-lg-5 m-order1" data-aos="fade-up" data-aos-delay="600">
						<div class="portfolio-detls pdr-dtls">
							<p class="port-tags">Viral Marketing</p>
							<a href="/solutions/app-development/web-app-development" class="port-title-main">Viral Marketing</a>
							<p class="mb30">we specialize in creative web app development that helps businesses and organizations streamline their operations and improve efficiency. Our team of experienced developers is skilled in creating custom web applications that are tailored to the unique needs of our clients.</p>
				...
				<div class="row">
					<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="200">
						<div class="portfolio-detls pdl-dtls">
							<p class="port-tags">Online Reputation Management</p>
							<a href="/solutions/app-development/mobile-app-development" class="port-title-main">Online Reputation Management</a>
							<p class="mb30">With the increasing demand for businesses to have a strong online presence, a well-designed mobile app can be a game changer. Not only can it improve customer engagement and loyalty, but it can also streamline internal processes and boost productivity.</p>
							<p class="mb30">Our team has a wealth of experience in developing high-quality mobile apps across a range of industries, using the latest technologies and methodologies to deliver exceptional results. </p>
							<a href="/solutions/app-development/mobile-app-development" class="port-links ">View More <i class="fas fa-arrow-right fa-btn"></i></a>
				...
				<div class="row">
					...
					<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="600">
						<div class="portfolio-detls pdr-dtls">
							<p class="port-tags">Influencer Marketing</p>
							<a href="/solutions/app-development/eCommerce-development" class="port-title-main">Influencer Marketing</a>
							<p class="mb30"> E-commerce app development has become an increasingly popular and important aspect of modern business. With the rise of mobile technology and the increasing amount of time people spend on their smartphones, it's no surprise that e-commerce apps have become a vital tool for businesses looking to reach new customers and sell their products online.</p>
							<a href="/solutions/app-development/eCommerce-development" class="port-links">View More <i class="fas fa-arrow-right fa-btn"></i></a>
					...
					<div class="row">
						...
						<div class="col-lg-5 m-order1" data-aos="fade-up" data-aos-delay="600">
							<div class="portfolio-detls pdr-dtls">
								<p class="port-tags">Email Marketing</p>
								<a href="/solutions/app-development/web-app-development" class="port-title-main">Email Marketing</a>
								<p class="mb30">we specialize in creative web app development that helps businesses and organizations streamline their operations and improve efficiency. Our team of experienced developers is skilled in creating custom web applications that are tailored to the unique needs of our clients.</p>
					...
					<div class="row">
						<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="200">
							<div class="portfolio-detls pdl-dtls">
								<p class="port-tags">SMS/WhatsApp Campaigns</p>
								<a href="/solutions/app-development/mobile-app-development" class="port-title-main">SMS/WhatsApp Campaigns</a>
								<p class="mb30">With the increasing demand for businesses to have a strong online presence, a well-designed mobile app can be a game changer. Not only can it improve customer engagement and loyalty, but it can also streamline internal processes and boost productivity.</p>
								<p class="mb30">Our team has a wealth of experience in developing high-quality mobile apps across a range of industries, using the latest technologies and methodologies to deliver exceptional results. </p>
								<a href="/solutions/app-development/mobile-app-development" class="port-links ">View More <i class="fas fa-arrow-right fa-btn"></i></a>
					...
					<div class="row">
						...
						<div class="col-lg-5 m-order2" data-aos="fade-up" data-aos-delay="600">
							<div class="portfolio-detls pdr-dtls">
								<p class="port-tags">Affiliate Marketing</p>
								<a href="/solutions/app-development/eCommerce-development" class="port-title-main">Affiliate Marketing</a>
								<p class="mb30"> E-commerce app development has become an increasingly popular and important aspect of modern business. With the rise of mobile technology and the increasing amount of time people spend on their smartphones, it's no surprise that e-commerce apps have become a vital tool for businesses looking to reach new customers and sell their products online.</p>
								<a href="/solutions/app-development/eCommerce-development" class="port-links">View More <i class="fas fa-arrow-right fa-btn"></i></a>
