			...
			<div class="row pt80 justify-content-center">
				<div class="col-lg-6">
					<div class="page-headings">
						<span class="sub-heading mb15" data-aos="fade-up" data-aos-delay="200">Wordpress</span>
						<h1 data-aos="fade-up" data-aos-delay="400">powering millions of websites <span class="ree-text rt40">worldwide </span> </h1>
						<p class="mt20 h-light" data-aos="fade-up" data-aos-delay="400">WordPress is a free and open-source content management system (CMS) based on PHP and MySQL. It is used to create and manage websites, blogs, and other online content.</p>
				...
				<div class="col-lg-6">
					<div class="sol-img m-mt30" data-aos="fade-in" data-aos-delay="400"><img src="{{asset('images/wordpress-intro-banner.png')}}" alt="web app development" class="img-fluid"></div>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row">
					<div class="col-lg-12 vcenter">
						<div class="cta-heading-2">
							<h2 class="mb15">What is <span class="ree-text rt40">Wordpress?</span></h2>
							<p class="mb15">WordPress is easy to use and has a large community of developers who contribute to its development and create a wide range of themes, plugins, and other tools that can be used to extend its functionality. It is also highly customizable, allowing users to create custom designs and add additional features to their websites using a variety of themes, plugins, and custom code.</p>
							<p class="mb15">WordPress was initially released in 2003 as a simple blogging platform, but has since evolved into a powerful and flexible CMS that is used by millions of websites worldwide. It is used by individuals, small businesses, and large organizations to create and manage a wide range of websites, including personal blogs, e-commerce stores, forums, and corporate websites.</p>
							<p class="mb15">WordPress is easy to use and has a large community of developers who contribute to its development and create a wide range of themes, plugins, and other tools that can be used to extend its functionality. It is also highly customizable, allowing users to create custom designs and add additional features to their websites using a variety of themes, plugins, and custom code.</p>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							<h2 class="mb15">Hire world-class <span class="ree-text rt40">Wordpress</span> developer for your <span class="ree-text rt40">project</span> </h2>
